...
export class APISearchTool extends BaseTool {
  ...
  readonly description = 'Intelligent API discovery with role-based filtering - searches the API registry to find relevant APIs based on objective context and user role';
